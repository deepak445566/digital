                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex gap-4 mt-4 md:mt-0">
                     <a
  href={`mailto:thisdigitalexpressindia30@gmail.com
  ?subject=Job Application for ${encodeURIComponent(selectedJob.title)}
  &body=Hello Team,%0D%0A%0D%0AI want to apply for the position of ${encodeURIComponent(selectedJob.title)}.%0D%0A%0D%0APlease find my resume attached.%0D%0A%0D%0ARegards`}
