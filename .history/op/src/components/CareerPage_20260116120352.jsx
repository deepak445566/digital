                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex gap-4 mt-4 md:mt-0">
                     // Apply Now बटन को अपडेट करें (Job Detail Modal में)
<button 
  onClick={() => window.location.href = `mailto:digitalexpressindia30@gmail.com?subject=Application for ${selectedJob.title}&body=Dear Hiring Team,%0D%0A%0D%0AI am writing to apply for the ${selectedJob.title} position.%0D%0A%0D%0APlease find my details below:%0D%0A%0D%0A- Name:%0D%0A- Contact:%0D%0A- LinkedIn Profile:%0D%0A- Portfolio/Resume:%0D%0A%0D%0ABest regards,%0D%0A[Your Name]`}
      ...
      <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
           // CTA Section में Submit Your Resume बटन को अपडेट करें
<button 
  onClick={() => window.location.href = 'mailto:digitalexpressindia30@gmail.com?subject=General Application - Resume Submission&body=Dear Talent Team,%0D%0A%0D%0AI am interested in opportunities at your company. Please find my resume attached.%0D%0A%0D%0A- Name:%0D%0A- Contact:%0D%0A- LinkedIn Profile:%0D%0A- Position of Interest:%0D%0A- Skills:%0D%0A%0D%0ABest regards,%0D%0A[Your Name]'}
