...
// Updated email helper functions
const openEmailClient = (subject, body) => {
  const email = 'digitalexpressindia30@gmail.com';
  ...
  setTimeout(() => {
    ...
    // If popup is blocked or window doesn't open, fallback to current window
    if (!newWindow || newWindow.closed || typeof newWindow.closed === 'undefined') {
      // Try using location.href
...
const sendEmailAlternative = (subject, body) => {
  const email = 'digitalexpressindia30@gmail.com';
...
// Updated apply function with fallback
// Simple direct approach
const applyNowEmail = (jobTitle) => {
  const email = 'digitalexpressindia30@gmail.com';
...
[Your Name]`);
  ...
  // Direct window location change (most reliable)
  window.location.href = `mailto:${email}?subject=${subject}&body=${body}`;
  
  // Add a fallback with a message
  setTimeout(() => {
    if (!document.hidden) {
      alert('If email client did not open, please manually send your resume to: digitalexpressindia30@gmail.com');
    }
  }, 1000);
};

const submitResumeEmail = () => {
...
const contactTalentTeamEmail = () => {
  const subject = 'Contact Talent Team';
  const body = `Dear Talent Team,

I would like to get in touch regarding opportunities at your company.
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button 
                ...
                className="px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-900 transition-all duration-300"
              >
                Why Join Us?
              </button>
            </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex gap-4 mt-4 md:mt-0">
                      <button 
                        onClick={() => applyNowEmail(selectedJob.title)}
