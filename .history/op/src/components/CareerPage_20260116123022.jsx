                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex gap-4 mt-4 md:mt-0">
                     <a
  href={`https://mail.google.com/mail/?view=cm&fs=1&to=thisdigitalexpressindia30@gmail.com
  &su=Job Application for ${encodeURIComponent(selectedJob.title)}
  &body=Hello Team,%0D%0A%0D%0AI want to apply for the position of ${encodeURIComponent(selectedJob.title)}.%0D%0A%0D%0APlease find my resume.%0D%0A%0D%0ARegards`}
  target="_blank"
  rel="noopener noreferrer"
  className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all inline-block"
>
  Apply Now
</a>
      ...
      <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
           <a
  href="https://mail.google.com/mail/?view=cm&fs=1&to=digitalexpressindia30@gmail.com&su=Resume Submission&body=Hello Team,%0D%0A%0D%0APlease find my resume attached.%0D%0A%0D%0ARegards"
  target="_blank"
  rel="noopener noreferrer"
  className="px-8 py-4 bg-white text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-colors shadow-lg inline-block"
>
  Submit Your Resume
</a>
