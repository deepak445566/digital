...
const ServiceDetail = () => {
  ...
  const initRazorpayPayment = async () => {
    ...
    try {
      ...
      const response = await fetch('https://your-backend-domain.com/api/payment/create-order', {
        method: 'POST',
        headers: {
  ...
  const verifyRazorpayPayment = async (paymentResponse) => {
    try {
      const response = await fetch('https://your-backend-domain.com/api/payment/verify', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center justify-center gap-2"
              >
                {razorpayLoading ? (
                  <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div>
            ...
            <div className="mb-6 lg:mb-8">
              ...
              {/* Action Buttons Row - Pay Online, Call & WhatsApp */}
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                {/* Pay Online Button - Only show if price is valid */}
                {servicePrice > 0 && (
                  <button 
                    onClick={() => setShowPaymentModal(true)}
                    className="flex-1 px-4 py-3.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 active:scale-95 shadow-lg flex items-center justify-center space-x-2 group"
                  >
            ...
            {servicePrice > 0 && (
              <div className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 sm:p-6 border border-purple-100">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center mr-3">
                ...
                <button 
                  onClick={() => setShowPaymentModal(true)}
                  className="mt-4 w-full px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <img src="https://razorpay.com/assets/razorpay-glyph.svg" alt="Razorpay" className="w-5 h-5" />
          ...
          <div>
            ...
            >
              <div className="text-center mb-6">
                ...
                {/* Price Badge in Form */}
                <div className="mt-4 inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full">
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4 shadow-2xl z-30">
              <div className="max-w-7xl mx-auto flex gap-3">
                {servicePrice > 0 && (
                  <button 
                    onClick={() => setShowPaymentModal(true)}
                    className="flex-1 bg-purple-600/20 backdrop-blur-sm py-3 rounded-xl flex items-center justify-center space-x-2 active:scale-95 transition-transform"
                  >
